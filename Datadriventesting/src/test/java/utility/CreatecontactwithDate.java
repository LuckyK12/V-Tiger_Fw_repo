...
String actualstart =  driver.findElement(By.id("dtlview_Support Start Date")).getText();
...
String actualend =  driver.findElement(By.id("dtlview_Support End Date")).getText();
if(actualend.equals(enddate)) {
 System.out.println("enddate matched");
}
else {
 System.out.println("enddate not matched");
}
driver.quit();
